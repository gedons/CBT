  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="false">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <h6 class="font-weight-bolder mb-0">Add New Level</h6>
      </nav>
  ...
  <div class="container-fluid py-4">
      ...
      <div class="card">
          <div class="card-header">
           ...
           <div class="card-body">
               <form action="{{ route('level.save')}}" method="post" enctype="multipart/form-data">
                   @csrf
                       <div class="row">
                            <center><label for="name" class="col-form-label">Name</label></center>
