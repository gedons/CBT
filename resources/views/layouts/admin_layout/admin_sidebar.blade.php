  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    ...
    <div class="navbar-nav-main  w-auto">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('admin.mode')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Mode of Study</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="{{route('admin.level')}}">
            ...
            <span class="nav-link-text ms-1">Student Level</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#cbt" class="nav-link collapsed" aria-controls="pagesExamples" role="button" aria-expanded="false">
          ...
          <span class="nav-link-text ms-1">CBT</span>
          </a>
          <div class="collapse" id="cbt" style="">
          <ul class="nav ms-4 ps-3">
          <li class="nav-item ">
          <a class="nav-link "  href="{{route('admin.cbt')}}">
          <span class="sidenav-normal"> Exams <b class="caret"></b></span>
          </a>
          </li>
           <li class="nav-item ">
          <a class="nav-link" href="{{route('admin.question')}}">
          <span class="sidenav-normal"> Questions <b class="caret"></b></span>
          </a>
          </li>
          </ul>
          </div>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{route('admin.profiles')}}">
            ...
            <span class="nav-link-text ms-1">Student Profiles</span>
          </a>
        </li>
